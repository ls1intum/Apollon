...
export interface IDeploymentNode extends IUMLContainer {
  stereotype: string;
}

export class DeploymentNode extends UMLContainer {
  type = DeploymentElementType.DeploymentNode;

  stereotype = 'node';

  constructor(values?: DeepPartial<IDeploymentNode>) {
    super();
    assign<IDeploymentNode>(this, values);
  }
