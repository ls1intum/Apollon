...
export const FlowchartFunctionCallComponent: FunctionComponent<Props> = ({ element }) => (
  <FlowchartComponent element={element}>
    <rect width="10px" height="100%" stroke={element.strokeColor || 'black'} x="0" />
    <rect width="calc(100% - 20px)" height="100%" stroke={element.strokeColor || 'black'} x="10" />
    <rect width="10px" height="100%" stroke={element.strokeColor || 'black'} x="calc(100% - 10px)" />
  </FlowchartComponent>
);
