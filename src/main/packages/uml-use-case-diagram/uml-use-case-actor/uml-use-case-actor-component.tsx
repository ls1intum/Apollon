...
export const UMLUseCaseActorComponent: FunctionComponent<Props> = ({ element, scale }) => (
  <g>
    ...
    <g stroke={element.strokeColor || 'black'} strokeWidth={2}>
      <ThemedCircle cx={45 * scale} cy={25 * scale} r={15 * scale} />
      <ThemedLine x1={45 * scale} y1={40 * scale} x2={45 * scale} y2={80 * scale} />
      <ThemedLine x1={15 * scale} y1={55 * scale} x2={75 * scale} y2={55 * scale} />
      <ThemedLine x1={45 * scale} y1={80 * scale} x2={15 * scale} y2={110 * scale} />
      <ThemedLine x1={45 * scale} y1={80 * scale} x2={75 * scale} y2={110 * scale} />
    </g>
