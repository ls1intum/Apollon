...
import { ControlFlowFlowLine } from './control-flow-flow-line';
...
class ControlFlowFlowLineUpdateComponent extends Component<Props> {
  render() {
        ...
        <section>
          <Flex>
            <Header gutter={false} style={{ flexGrow: 1 }}>
              {this.props.translate('packages.ControlFlowDiagram.ControlFlowFlowLine')}
            </Header>
...
export const ControlFlowFlowLineUpdate = enhance(ControlFlowFlowLineUpdateComponent);
