...
class ControlFlowFunctionCallUpdateComponent extends Component<Props> {
  render() {
      ...
      <div>
        <section>
          <Flex>
            <Textfield
              value={element.name}
              placeholder={this.props.translate('packages.ControlFlowDiagram.ControlFlowFunctionCall')}
