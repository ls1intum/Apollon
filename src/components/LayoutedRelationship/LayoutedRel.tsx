...
//       .filter(
//         s => Object.keys(state.elements).filter(id => state.elements[id].name !== 'Relationship').includes(s)
//       ) as UUID[],
//     relationshipIds: Object.keys(state.elements)
//       .filter(k => state.elements[k].selected)
//       .filter(s => Object.keys(state.elements).filter(id => state.elements[id].name === 'Relationship').includes(s)) as UUID[],
//   },
// });
