 ...
 *
 * Mirrors `HomeHeaderRow`'s outer rhythm (the `home-content-x` gutter, the
 * 1536px max width, and the `pt-5/md:pt-6` resting offset) so the brand island
 * lands at the same baseline whether the user is on the home or a sub-page.
 * Left: the brand banner (logo + version) linking home. Right: an actions island
 * with the shared back affordance, the Help menu, and the theme switcher.
 */
