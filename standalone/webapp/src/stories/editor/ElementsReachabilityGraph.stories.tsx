...
/**
 * The individual reachability-graph element renderers (the SVGs the Sidebar
 ...
 */
const meta = {
  title: "Editor/Elements/Reachability Graph",
...
const configs = elementConfigsFor("ReachabilityGraph")

/** All reachability-graph element shapes laid out together. */
...
export const Marking: Story = { args: { config: configs[0] } }
