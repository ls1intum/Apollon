...
const configs = elementConfigsFor("ClassDiagram")

/** All class-diagram element shapes laid out together. */
...
export const Package: Story = { args: { config: configs[0] } }
export const Class: Story = { args: { config: configs[1] } }
