...
/**
 * The individual communication-diagram element renderers (the SVGs the Sidebar
 ...
 */
const meta = {
  title: "Editor/Elements/Communication Diagram",
...
const configs = elementConfigsFor("CommunicationDiagram")

/** All communication-diagram element shapes laid out together. */
