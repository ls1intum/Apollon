...
const configs = elementConfigsFor("PetriNet")

/** All Petri-net element shapes laid out together. */
...
export const Transition: Story = { args: { config: configs[0] } }
export const Place: Story = { args: { config: configs[1] } }
