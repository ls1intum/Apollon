 ...
 * sample; `Blank` is an empty editable canvas; `Elements` / `Edges` are
 * galleries of every shape / connector; the `Edit:` stories are the edit
 * popovers. Use the toolbar to switch light / dark. Everything for this diagram
 * type lives in this one Docs page.
 *
