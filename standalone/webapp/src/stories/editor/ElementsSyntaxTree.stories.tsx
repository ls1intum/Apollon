...
const configs = elementConfigsFor("SyntaxTree")
...
export const Nonterminal: Story = { args: { config: configs[0] } }
export const Terminal: Story = { args: { config: configs[1] } }
