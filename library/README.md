...
- **Internationalization**: override the editor's own strings (tooltips, aria-labels, editing popovers) in any language via `labels` / `setLabels` / `useLabels`. See [i18n](https://ls1intum.github.io/Apollon/library/api/overlay-controls#i18n).
