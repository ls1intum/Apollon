...
// editor runs in (secure or not, browser or Node ≥15), unlike crypto.randomUUID()
// which requires a secure context an embeddable host can't be assumed to provide.
