...
// Crow's-foot (Mermaid / IE-style) entity — a table with aligned columns: a key
// gutter (PK/FK/UK), the column name, and a muted data type. Colours flow through
// the shared getCustomColorsFromData path exactly like the class diagram, so the
// header default matches the rows (white) and the entity fill themes the header.
